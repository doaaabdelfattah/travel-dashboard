export const OrdersTableHeader = [
  ...
  { id: 2, KEY: "orderDate", LABEL: "Date", hiddenOnSmall: true }, // Match the correct field for sorting
  { id: 3, KEY: "user", LABEL: "Customer", hiddenOnSmall: false },
  { id: 4, KEY: "trips", LABEL: "Trips", hiddenOnSmall: false },
  { id: 5, KEY: "total", LABEL: "Amount £", hiddenOnSmall: false }, // Correct key for sorting amount
  { id: 6, KEY: "paymentMethod", LABEL: "Payment Method", hiddenOnSmall: true }, // Match the payment field
